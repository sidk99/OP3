...
class IodineVAE(GaussianLatentVAE):
    ...
    def forward(self, input, segmentations, actions=None, schedule=None, seedsteps=5):
        return self._forward_dynamic_actions(input, actions, schedule, segmentations)
    ...
    def _forward_dynamic_actions(self, input, actions, schedule, segmentations, initial_lambdas=None):
