...
<mujoco>
    ...
    <worldbody>
        ...
        <geom name='wall_floor' type='plane' pos='0 0 0' euler='0 0 0' size='20 10 0.1' 
        material='wall_visible' condim="6" friction="1 1 1"/>
        {}
    </worldbody>
    ...
    def get_body_str(self):
        body_base = '''
          <body name='{}' pos='{}' quat='{}'>
            ...
            conaffinity="1" condim="6" friction="1 1 1"/>
          </body>
        '''
